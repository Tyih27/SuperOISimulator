...
5. 在“学生名单”改名，在“训练与补给”进行学生强化、购买训练册或招募学生。强化每次消耗 100 训练币，并按学生资质增加目标能力（普通 +15、优秀 +20、稀有 +25、天才 +30、顶尖 +40）；有对应专项训练册时优先消耗训练册，否则可消耗 1 份学生培养材料。能力达到 2,000 上限、训练币不足或材料不足时不会改变档案。
