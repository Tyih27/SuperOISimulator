...
5. 在“学生名单”改名，在“训练与补给”进行学生强化、购买训练册或招募学生。强化按学生资质增加目标能力（普通 +15、优秀 +20、稀有 +25、天才 +30、顶尖 +40）；优先消耗对应专项训练册且不收取训练币，没有对应训练册时可消耗 1 份学生培养材料并支付 100 训练币。商店可购买精力药剂（150 训练币），在学生档案页使用可使该学生最大精力 +500。能力达到 2,000 上限、训练币不足或材料不足时不会改变档案。
