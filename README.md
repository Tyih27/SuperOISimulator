...
- 每名学生固定引用一个可扩展的个人技能组，组内包含一对常规和爆发技能
- 每道题目怪配置自己的技能、目标规则和伤害参数；技能不按题目位置共用
...
当前已完成项目计划中的 Task 1 至 Task 7：战斗契约与三人编队、版本化领域模型、PostgreSQL API 基础、账号认证、版本化玩家档案和云存档、主线奖励、专项训练、商店与招募，以及服务端权威的单人战斗结算。下一项工作是 Task 8：账号、主线、名单和进度界面。
